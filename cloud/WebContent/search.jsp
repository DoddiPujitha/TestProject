        ...
        <nav class="navbar fixed-top navbar-expand-lg navbar-light navbar-fixed-top">
            <div class="container">
                <h1 class="wthree-logo">
                    <a href="search.jsp" id="logoLink" data-blast="color">Search Files</a>
                </h1>
            </div>
        </nav>
        <!-- //header -->
        ...
        <div class="container-fluid">
            <div class="row banner-row">
                <div class="col-lg-8 bg-img text-center">
                    <h3 class="agile-title">Search Files from Cloud</h3>
                    <div class="bnr-img">
                    ...
                    <div id="login-row">
                        ...
                        <div id="login-column">
                            <div class="box">
                                ...
                                <div class="float">
                                    <form class="form" action="search11.jsp" method="post">
                                        <div class="form-group">
                                            <label for="Keyword">Keyword</label><br>
                                            <input type="text" name="keyword" id="username" class="form-control"
                                                placeholder="Keyword" required>
                                        </div>
                                        <div class="form-group">
                                            <label for="Required Files">Required Files</label><br>
                                            <input type="number" name="nooffiles" id="password" class="form-control"
                                                placeholder="" required>
                                        </div>
                                        <div class="form-group btn-agile">
                                            <input type="submit" name="submit" class="btn btn-primary btn-md" value="Process">
                                        </div>
                                    </form>
                                </div>
                            </div>
