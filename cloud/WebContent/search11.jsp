...
String number=request.getParameter("nooffiles");
...
String sql ="select fid,securitykey,photourl,file from fileupload where file like '%"+keyword+"%'";
    ...
    <div id="home" class="banner" data-blast="bgColor">
        ...
        <nav class="navbar fixed-top navbar-expand-lg navbar-light navbar-fixed-top">
            <div class="container">
                <h1 class="wthree-logo">
                    <a href="#" id="logoLink" data-blast="color">View Files</a>
                </h1>
            </div>
         ...
         <div class="container-fluid">
            <div class="row banner-row">
                <div class="col-lg-8 bg-img text-center">
                    <h3 class="agile-title">View Files from Cloud</h3>
                    <div class="bnr-img">
                ...
                <div class="col-lg-4  my-auto p-0">
                    ...
                    <div id="login-row">
                        ...
                        <div id="login-column">
		                  ...
		                  <tr>
			               <td class="table-success"><b>FILEID</b></td>
			               <td class="table-success"><b>FILENAME</b></td>
                           <td class="table-success"><b>ACTION</b></td></tr>
		    <%
		...
		<tr style="background-color: #ffffcc;">
		 <TD><%=resultSet.getString("fid")%></TD>
		   ...
		   <td><a href="download_file.jsp?id=<%=resultSet.getString("fid")%>&&fname=<%=resultSet.getString("file")%>&&fkey=<%=resultSet.getString("securitykey")%>" style="color:red;">Download</a></TD>
		   </tr>
		<%
			}
		%>
